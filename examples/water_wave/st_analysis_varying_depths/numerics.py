...
def main():
	r"""
	This program numerically computes the horizontal Stokes drift velocity of
	inertial particles in linear water waves for various Stokes numbers and
	water depths, and saves the results to the `data/water_wave` directory.
	"""
	...
	numerics.to_csv(DATA_PATH + 'drift_velocity_varying_st.csv', index=False)
