...
from examples.water_wave.drift_velocity.numerics import DEPTH, AMPLITUDE, \
	 WAVELENGTH, STOKES_NUM, BETA

IN_FILE = '../../../data/water_wave/drift_vel_numerics.csv'
OUT_FILE = '../../../data/water_wave/dibenedetto_analytics.csv'
