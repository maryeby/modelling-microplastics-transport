...
from examples.deep_water_wave.drift_velocity_numerics import AMPLITUDE, \
															 WAVELENGTH, DEPTH
OUT_FILE = '../data/deep_water_wave/analytics.csv'
...
def main():
	...
	Notes
	-----
	The non-dimensional equation, $$u_d = e^{2z},$$ is based on the dimensional
	equation[^1], $$u'_{SD} = c'(A'k')^2 e^{2k'z'}.$$
	...
	# compute drift velocity and write results to data file
	u_d = np.exp(2 * z)
