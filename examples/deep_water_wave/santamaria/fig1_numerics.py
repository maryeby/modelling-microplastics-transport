...
STOKES_NUM = 0.5	# according to Santamaria et al. (2013)
HEAVY_BETA = 0.96
LIGHT_BETA = 1.04
...
OUT_FILE = '../../data/deep_water_wave/santamaria_fig1_recreation.csv' 
...
def main():
	...
	x_0, z_0 = 0, 0
	timestep = DELTA_T / (wave.angular_freq * wave.froude_num) # scale time
	...
	particle = prt.Particle(STOKES_NUM * wave.froude_num * HEAVY_R)
	...
	particle = prt.Particle(STOKES_NUM * wave.froude_num * LIGHT_R)
