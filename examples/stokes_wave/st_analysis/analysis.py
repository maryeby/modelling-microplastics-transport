...
from examples.stokes_wave.st_analysis.numerics import OUT_FILE as IN_FILE

EXT_RANGE = 300
MAXFEV = 100000
OUT_FILE = '../../data/stokes_wave/st_analysis.csv'
...
def main():
	...
	+ \text{offset}.$$ Results are saved to the `data/stokes_wave` directory.
