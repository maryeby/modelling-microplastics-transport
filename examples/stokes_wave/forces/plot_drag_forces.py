...
from utils.data_tools import print_characteristic_params as print_params
from utils.plot import initialize_figure as fig
from utils.colors import COLORS
from models import stokes_wave as fl
from examples.linear_wave.forces.numerics import DEPTH, WAVELENGTH, \
												 NUM_PERIODS
...
def main():
	...
	print_params(fl.StokesWave(DEPTH, AMPLITUDE, WAVELENGTH),
				 stokes_hat=STOKES_NUM / (1 / R - 0.5), density_ratio=R)
