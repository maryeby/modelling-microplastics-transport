...
from examples.deep_linear_wave.santamaria.fig2_numerics import DELTA_TS
from examples.deep_linear_wave.santamaria.fig2_numerics import OUT_FILE as \
															   IN_FILE1
from examples.deep_linear_wave.santamaria.analytics import OUT_FILE as \
														   IN_FILE2
...
def main():
	...
	fig(r'$t$', r'$\bar{u}$', 121, make_square=True, lims=[0, 80, 0, 0.125])
	...
	fig(r'$t$', r'$\bar{w}$', 122, make_square=True, lims=[0, 80, -0.1425,
														  -0.1245])
