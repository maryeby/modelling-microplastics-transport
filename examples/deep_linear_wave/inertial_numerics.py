...
R = SCALE * BETA				# density ratio from Haller & Sapsis (2008)
NUM_PERIODS = 5
DELTA_T = 5e-3
...
AMPLITUDE = 0.026
WAVELENGTH = 0.5
STOKES_HAT = SCALE * BETA * 0.5	# translated St from Santamaria et al. (2013)
X_0, Z_0 = 0, 0					# initial particle position
OUT_FILE = '../data/deep_linear_wave/inertial_numerics.csv'
...
def simulate_equations(system, order, method, results):
	...
	timestep = DELTA_T / omega if method == 'Santamaria' else DELTA_T
