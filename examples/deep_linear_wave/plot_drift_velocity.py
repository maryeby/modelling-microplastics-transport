...
from examples.deep_linear_wave.drift_velocity_numerics import STOKES_HATS

IN_FILE1 = '../data/deep_linear_wave/drift_velocity_numerics.csv'
IN_FILE2 = '../data/deep_linear_wave/analytics.csv'
