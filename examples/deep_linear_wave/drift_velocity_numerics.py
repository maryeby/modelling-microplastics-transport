...
HIDE_PROGRESS = True
OUT_FILE = '../data/deep_linear_wave/drift_velocity_numerics.csv'
...
def main():
	...
	paired_st, paired_z_0 = zip(*itertools.product(STOKES_HATS, z_0s))
...
def run_numerics(wave, stokes_hat, z_0, t):
	"""
	...
	return {'z_bar/h': normalized_z_bar, 'u_bar': u_bar, 'St': stokes_hat}
